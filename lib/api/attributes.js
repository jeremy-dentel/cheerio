...
var serialize = exports.serialize = function() {
  var serialized = serializeElements(this);
  var serializedString = '';

  _.each(serialized, function (elem, index, list) {
    var serializedElement = elem.name + '=' + elem.value + '&';
...
var serializeArray = exports.serializeArray = function() {
  return serializeElements(this);
}

var serializeObject = exports.serializeObject = function() {
  var serialized = serializeElements(this);
  var serializedObject = {};

  _.each(serialized, function (elem, index, list) {
    serializedObject[elem.name] = elem.value;
  });
...
/*
 * Takes in an array of elements, returns an array of objects with
 * name and value pairs to be serialized
 */
...
function serializeElements(elements) {
  if (elements && elements.length) {
    ...
    _.each(elements, function(elem, index, list) {
      var attributes = elem.attribs;
      // Verify that the element has a name and value. 
      if (attributes && attributes.length && attributes.name && attributes.value) {
        serialized.push({
